...
export JENKINS_X_URL='https://dashboard-jx.jx.mqube.build/spring-financial-group/terraform-jx-azure/main/3'
...
export MINK_IMAGE='jx3mqubebuild.azurecr.io/spring-financial-group/terraform-jx-azure:0.1.2'
