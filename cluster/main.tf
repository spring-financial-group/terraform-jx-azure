...
provider "kubernetes" {
  ...
  client_certificate     = var.azure_k8s_rbac_enabled ? null : base64decode(module.cluster.client_certificate)
  client_key             = var.azure_k8s_rbac_enabled ? null : base64decode(module.cluster.client_key)
}
...
module "cluster" {
  ...
  enable_node_zone_spanning                     = var.enable_node_zone_spanning
  ...
  ml_node_zones                                 = var.ml_node_zones
  ...
  build_node_zones                              = var.build_node_zones
  ...
  mlbuild_node_zones                            = var.mlbuild_node_zones
